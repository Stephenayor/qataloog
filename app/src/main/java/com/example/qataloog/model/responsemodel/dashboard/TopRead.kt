...
data class TopRead (
    ...
    companion object CREATOR : Parcelable.Creator<TopRead> {
        override fun createFromParcel(parcel: Parcel): TopRead {
            return TopRead(parcel)
        }

        override fun newArray(size: Int): Array<TopRead?> {
